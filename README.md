...
dados de apoio. O conteúdo das pastas é a **biblioteca de material** — ele é reutilizável de um
...
> Ao editar o conteúdo de uma aula, edite o **gabarito** e gere o notebook limpo a partir dele.
> O gabarito é a fonte da verdade, já que é ele que tem o código.
